...
//        templates.add("template/biz.java.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
                zip.putNextEntry(new ZipEntry(getFileName(template, tableEntity.getClassName(), config.getString("package")+"."+config.getString("serviceName"), config.getString("mainModule"))));
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("index.js.vm")) {
            return frontPath + "api"  + File.separator +toLowerCaseFirstOne(className)+ ".js";
        }
        if (template.contains("crud.js.vm")) {
            return frontPath + "const"  + File.separator+"crud" +File.separator+toLowerCaseFirstOne(className)+ ".js";
        }
        if (template.contains("index.vue.vm")) {
            return frontPath + "views" +  File.separator + toLowerCaseFirstOne(className) + File.separator + "index.vue";
        }
        if (template.contains("sql.vm")) {
            return frontPath + "sql" +File.separator + toLowerCaseFirstOne(className)+"sql.txt";
        }
